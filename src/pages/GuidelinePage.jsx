...
const GuidelinePage = () => {
  return (
    <div className="flex flex-col min-h-screen dark:bg-[#18171C]">
      {/* 헤더 */}
      <Header />
      {/* 메인 컨텐츠 */}
      <main className="relative px-6 lg:px-16 py-10 mt-24">
        ...
        <div className="md:w-[60%] w-[80%] mx-auto">
          ...
          {/* 7가지 작성 지침 */}
          <section id="7-instructions" className="mt-16">
            <h2 className="text-[#1A1A1A] dark:text-white text-3xl font-semibold">ChatGPT를 효과적으로 활용하는 7가지 프롬프트 작성 지침</h2>
          </section>
          {/* 1번째째 지침 */}
          <section className="mt-16">
            <h2 className="text-[#1A1A1A] dark:text-white text-2xl font-semibold">1. AI에게 역할을 부여하세요</h2>
            ...
            <div className="bg-[#A476CC1A] text-[#4E4E4E] dark:text-[#BBBBBB] p-4 mt-6 rounded-md border-l-8 border-[#A476CC]">
          ...
          {/* 2번째 지침 */}
          <section className="mt-16">
            <h2 className="text-[#1A1A1A] dark:text-white text-2xl font-semibold">2. 명확하고 설명적이며 정확한 과제를 부여하세요</h2>
            <p className="text-[#4E4E4E] dark:text-[#BBBBBB] mt-4">
          ...
          {/* 3번째 지침 */}
          <section className="mt-16">
            <h2 className="text-[#1A1A1A] dark:text-white text-2xl font-semibold">3. 충분한 배경 정보를 입력하세요</h2>
            <p className="text-[#4E4E4E] dark:text-[#BBBBBB] mt-4">
          ...
          {/* 4번째 지침 */}
          <section className="mt-16">
            <h2 className="text-[#1A1A1A] dark:text-white text-2xl font-semibold">4. 예제를 제공해 주세요  </h2>
            <p className="text-[#4E4E4E] dark:text-[#BBBBBB] mt-4">
          ...
          {/* 5번째 지침 */}
          <section className="mt-16">
            <h2 className="text-[#1A1A1A] dark:text-white text-2xl font-semibold">5. 규칙을 구체적으로 정하세요  </h2>
            <p className="text-[#4E4E4E] dark:text-[#BBBBBB] mt-4">
          ...
          {/* 6번째 지침 */}
          <section className="mt-16">
            <h2 className="text-[#1A1A1A] dark:text-white text-2xl font-semibold">6. 제약 조건을 구체적으로 알려주세요</h2>
            <p className="text-[#4E4E4E] dark:text-[#BBBBBB] mt-4">
          ...
          {/* 7번째 지침 */}
          <section className="mt-16">
            <h2 className="text-[#1A1A1A] dark:text-white text-2xl font-semibold">7. 평가하고 반복하세요 </h2>
            <p className="text-[#4E4E4E] dark:text-[#BBBBBB] mt-4">
          ...
          {/* 고급 프롬프트 팁 */}
          <section id="advanced-tip" className="mt-16">
            <h2 className="text-[#1A1A1A] dark:text-white text-3xl font-semibold">ChatGPT를 더 똑똑하게 활용하는 고급 프롬프트 팁</h2>
          </section>
          {/* 1번째 팁 */}
          <section className="mt-16">
            <h2 className="text-[#1A1A1A] dark:text-white text-2xl font-semibold">1. 생각 과정을 유도하는 질문을 해보세요.</h2>
            <p className="text-[#4E4E4E] dark:text-[#BBBBBB] mt-4">
          ...
          {/* 2번째 팁 */}
          <section className="mt-16">
            <h2 className="text-[#1A1A1A] dark:text-white text-2xl font-semibold">2. 나의 상황과 배경을 더 많이 알려주세요  </h2>
            <p className="text-[#4E4E4E] dark:text-[#BBBBBB] mt-4">
          ...
          {/* 3번째 팁 */}
          <section className="mt-16">
            <h2 className="text-[#1A1A1A] dark:text-white text-2xl font-semibold">3. 예시를 먼저 보여주면 AI가 더 잘 따라해요 </h2>
            <p className="text-[#4E4E4E] dark:text-[#BBBBBB] mt-4">
          ...
          {/* 프롬프트 고급 설정 */}
          <section id="advanced-setting" className="mt-16">
            <h2 className="text-[#1A1A1A] dark:text-white text-2xl font-semibold">프롬프트 고급 설정: temperature, top_p, max length 이해하기</h2>
            <p className="text-[#4E4E4E] dark:text-[#BBBBBB] mt-4">
          ...
          {/* 1번째 설정 */}
          <section className="mt-16">
            <h2 className="text-[#1A1A1A] dark:text-white text-2xl font-semibold">1. temperature (온도 설정)</h2>
            <p className="text-[#4E4E4E] dark:text-[#BBBBBB] mt-4">
          ...
          {/* 2번째 설정 */}
          <section className="mt-16">
            <h2 className="text-[#1A1A1A] dark:text-white text-2xl font-semibold">2. top_p (핵 샘플링)</h2>
            <p className="text-[#4E4E4E] dark:text-[#BBBBBB] mt-4">
          ...
          {/* 3번째 설정 */}
          <section className="mt-16">
            <h2 className="text-[#1A1A1A] dark:text-white text-2xl font-semibold">3. max length (응답 길이 제한)</h2>
            <p className="text-[#4E4E4E] dark:text-[#BBBBBB] mt-4">
        ...
        <aside className="hidden lg:block absolute top-20 right-12 w-52">
          <div className="fixed top-64 bg-[#F5F5F5] dark:bg-[#2E2C36] p-6 rounded-lg text-sm w-[200px]">
            ...
            <ul className="mt-4 space-y-2 text-[#4E4E4E] dark:text-[#BBBBBB]">
              ...
              <li><a href="#advanced-tip" className="hover:text-[#1A1A1A] hover:underline dark:hover:text-white">고급 프롬프트 팁</a></li>
              <li><a href="#advanced-setting" className="hover:text-[#1A1A1A] hover:underline dark:hover:text-white">프롬프트 고급 설정</a></li>
            </ul>
          </div>
        </aside>
      </main>
